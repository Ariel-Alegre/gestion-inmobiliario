...
const SvgComponent = (props) => {
  ...
  const [open235, setOpen235] = React.useState(false);
  const [open236, setOpen236] = React.useState(false);
  const [open237, setOpen237] = React.useState(false);
  const [open238, setOpen238] = React.useState(false);
  const [open239, setOpen239] = React.useState(false);
